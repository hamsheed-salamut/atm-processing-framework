...
namespace Transaction.WebApi.Middlewares
{
    public class ExceptionHandlerMiddleware : IMiddleware
    {
        ...
        public async Task HandleExceptionAsync(HttpContext context, Exception e)
        {
            ...
            else if (e is Transaction.Core.Exceptions.TransactionException)
            {
            ...
            else
            {
                ...
                result.Message = "Unknown error, please contact system admin";
            }
        ...
        private string CreateMessage(HttpContext context, Exception e)
        {
            ...
            {
                message = $"{message}, inner exception message {e.InnerException}, inner exception stack {e.InnerException.StackTrace}";
            }

            return $"{message} Request Id: {context.TraceIdentifier}";
        }
    }
}
