...
namespace Transaction.Service.Mappers
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<AccountTransactionEntity, TransactionResult>()
                ...
                .ForMember(dest => dest.Message, opt => opt.MapFrom(o => o.TransactionId > 0 ? StringResources.TransactionSuccessful : StringResources.TransactionFailed))
            ...
            CreateMap<AccountSummary, TransactionResult>()
                ...
                .ForMember(dest => dest.Message, opt => opt.MapFrom(o => StringResources.TransactionSuccessful));
        }
    }
}
